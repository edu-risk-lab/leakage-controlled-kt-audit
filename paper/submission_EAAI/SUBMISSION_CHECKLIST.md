...
- [x] Abstract ≤ 250 words (current draft ≈ 222)
- [x] Keywords: 1–6
...
- [x] Supplementary PDF (`supplementary_EAAI.pdf`, 21 pages)
...
The rewrite sells the **train-only graph audit + disruption-rate instrument** as the AI method, and **tutoring-system verification** as the application, with a **bounded negative result** (graph-channel leakage moved AUC by at most 0.010 under the tested regimes).
