...
def main() -> int:
    ...
    tex = (
        ...
        "\\begin{table}[h!]\n\\centering\n"
        "\\caption{DDR vs.\\ downstream graph-KT accuracy (Table S23). For each dataset and model, the prerequisite graph "
    ...
    paper_tex = ROOT / "paper" / "submission_EAAI" / "ddr_downstream.tex"
