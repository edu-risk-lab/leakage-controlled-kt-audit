...
\begin{table}[t]
\centering
\caption{Train-only vs.\ full-log graph ablation: XES3G5M (earlier code vintage;
operating-point GKT numbers are in the main-text Table~\ref{tab:m4-phase-b-auc}).}
